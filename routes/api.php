...
Route::middleware('auth:sanctum')->group(function () {
    Route::post('/urls', [ShortURLController::class, 'create']); 
...
Route::get('/r/{shortUrl}', [ShortURLController::class, 'redirect']); 

Route::get('/url/{shortUrl}', [ShortURLController::class, 'redirect']);
